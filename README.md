Latex docker container [![Docker hub](https://img.shields.io/docker/pulls/0000matteo0000/latex.svg)](https://hub.docker.com/r/0000matteo0000/latex/)
======================
...
Versions
--------
All versions are based on Ubuntu: ([See all tags](https://hub.docker.com/r/0000matteo0000/latex/))

- [0000matteo0000/latex:ubuntu (:latest) - Dockerfile.ubuntu](Dockerfile.ubuntu) Ubuntu TexLive distribution: Old but stable, most needed package: texlive-full (3.9GB)
- [0000matteo0000/latex:ctanbasic - Dockerfile.basic](Dockerfile.basic) CTAN TexLive Scheme-basic: Up-to-date, only basic packages, base for custom builds (500MB)
- [0000matteo0000/latex:ctanfull - Dockerfile.full](Dockerfile.full) CTAN TexLive Scheme-full: Up-to-date, all packages (5.6GB)

If you need...
- ...the most-stuff-works-out-of-the-box package, try `0000matteo0000/latex:ubuntu`.
- ...the most recent version of everything, try `0000matteo0000/latex:ctanfull`.
- ...a stable base for your custom texlive build, try `0000matteo0000/latex:ctanbasic`.

For stability, choose a more specific version tag ([See all tags](https://hub.docker.com/r/0000matteo0000/latex/))
